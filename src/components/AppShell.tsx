import { BarChart3, BookOpen, Gauge, Home, LibraryBig, Settings } from 'lucide-react';
...
export function AppShell(){
  ...
  const nav=[['/','Home',Home],['/learn','Learn',BookOpen],['/practice','Practice',Gauge],['/reference','Reference',LibraryBig],['/progress','Progress',BarChart3]] as const;
